...
@section('content')
<a href="javascript:history.back()" class="btn btn-lg btn-primary"><i class="bi bi-arrow-left"></i>Volver</a>
    <div class="container text-center">
        
        @if ($stolpersteines)
        <div class="row m-0 mostrardatos" data-id_mostrar={{ $stolpersteines->id }}>
